...
- **The expensive thing is human review, not verification.** Verification is
  ...
  Rs 3.36 crore at the 32.3% it escalates, or Rs 2.08 crore held to the 20% it
  declared. Both are in the proposal, both conditionally framed. The eval set is
  57.7% harmful, so neither is a forecast - say so when quoting either.
